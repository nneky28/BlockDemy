...
const CourseInfo: React.FC<Props> = ({ course_ }) => {
  ...
  const { setWalletConnected } = useContext(DAppContext);
    ...
    <>
      ...
      <div className={styles.lower}>
        ...
        <div className={styles.top}>
          ...
          <ul>
            <li>
              Smart Contracts: Gain a solid understanding of what smart
              contracts
            </li>
            <li>Writing Your First Smart Contract on Ethereum blockchain</li>
            <li>
              The programming language used to write smart contracts on Ethereum
            </li>
            <li>
              Advanced Solidity Programming in topics like, modifiers, error
              handling
            </li>
          </ul>
        </div>
      ...
      <div className={styles.cards}>
          ...
          <div className={styles.brief}>
            <div className={styles.head}>
              ...
              <div className={styles.amount}>
                <Image className={styles.token} alt="" src={bdt} />
                <span>2</span>
              </div>
            </div>
            <span className={styles.text}>
              To enroll, you need Blockdemy tokens. <strong>Purchase</strong>
            </span>
          </div>
          <button onClick={(e) => enrollNow(e)}>
        ...
        <div className={styles.recent}>
          ...
          <div className={styles.card2}>
            <div className={styles.imageDiv}>
              <Image className={styles.image} alt="" src={frontend} />
            </div>
            <div className={styles.brief}>
              <span className={styles.title}>Purchase Token</span>
              <span className={styles.description}>
                Journey through the latest tools and techniques in front-end
                development, crafting immersive user experiences and staying at
                the forefront of web design innovation.
              </span>
            </div>
            <div className={styles.info}>
